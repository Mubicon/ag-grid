 ...
 * @license MIT
 */
function Gs(e,t,o,i,n){void 0===n&&(n=!1),console.warn("ag-Grid: Since ag-grid 11.0.0 defaultGroupComparator is not necessary. You can remove this from your colDef");var r=p.exists(o)&&o.group,s=p.exists(i)&&i.group,a=!r&&!s;return r&&s?p.defaultComparator(o.key,i.key,n):a?p.defaultComparator(e,t,n):r?1:-1}
/**
 * @ag-grid-community/core - Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
 * @version v22.0.0
 * @link http://www.ag-grid.com/
